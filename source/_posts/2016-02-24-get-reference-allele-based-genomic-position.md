...
<pre>$samtools faidx ucsc.hg19.fasta chr1:49999-50001
>chr1:49999-50001
ATA</pre>

## 2, twoBitToFa 

<pre>$wget http://hgdownload.soe.ucsc.edu/admin/exe/linux.x86_64/faToTwoBit
...
<pre>$wget -qO- http://genome.ucsc.edu/cgi-bin/das/hg19/dna?segment=chr1:49999,50001 ' grep -v '<&#039;
ata</pre>
<!--more-->

## 4, bedtools getfasta

<pre>$bedtools getfasta -fi ucsc.hg19.fasta -bed test.bed -fo -
>chr1:49998-50001
ATA</pre>
...
<pre>$wget http://togows.org/api/ucsc/hg19/chr1:49999-50001.fasta -O - -q
