...
<pre>diff=read.table("./gene_exp.diff",sep="t",header=TRUE)
# 差异表达基因
...
<pre>source("https://bioconductor.org/biocLite.R")
chooseBioCmirror()
biocLite("topGO")
...
![](https://raw.githubusercontent.com/ProfessionalFarmer/f4w/master/2020/2016-08-16-go.dag.png)  
