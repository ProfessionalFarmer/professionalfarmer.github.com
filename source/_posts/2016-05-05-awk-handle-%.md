...
<pre>> echo -e "1t2n3t4" ' awk '{if($1==1){print $0}}'
1       2</pre>

但如果碰到带有百分号%的数据时，则不能直接通过加减乘除进行计算或者判断

<pre>> echo -e "1%t2%n3%t4%" ' awk '{if($1==0.01){print $0}}'
></pre>
...
<pre>> echo -e "1%t2%n3%t4%" ' awk '{if($1>0.5){print $0}}'
1%      2%
3%      4%</pre>
...
<pre>> echo -e "1%t2%n3%t4%" ' awk '{if($1>0.0009){print $0}}'
1%      2%
3%      4%
...
<pre>> echo -e "1%t2%n3%t4%" ' awk '{if($1+0==1){print $0}}'   
1%      2%</pre>
