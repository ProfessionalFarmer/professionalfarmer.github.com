...
<pre>/path/to/secondary/storage/2420294/0011
├── Analysis_Results
...
└── m140415_143853_42175_c100635972550000001823121909121417_s1_p0.metadata.xml</pre>
...
<pre>DATASET "/PulseData/BaseCalls/Basecall" {
...
<pre>DATASET "/PulseData/BaseCalls/QualityValue" {
   ...
   (92): 1, 0, 5, 1, 0, 0, 1, 0, 2, 1, 0, 0, 21, 0, 1, 0, 0, 20, 0, 0, 0, 16, 1,</pre>
...
<pre>wget -c https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.10/hdf5-1.10.5/src/hdf5-1.10.5.tar.gz
