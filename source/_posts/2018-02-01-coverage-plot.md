...
<pre># Get a list of the bedtools output files you'd like to read in
print(files  smp5
...
![](https://raw.githubusercontent.com/ProfessionalFarmer/f4w/master/2020/2018-02-01-target-region-coverage.png)
