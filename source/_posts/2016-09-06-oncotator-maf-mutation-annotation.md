...
<pre>curl -O https://pypi.python.org/packages/source/v/virtualenv/virtualenv-14.0.6.tar.gz
tar -xvzf virtualenv-14.0.6.tar.gz 
cd virtualenv-14.0.6/
python setup.py install --prefix=~/pypackages/
cd ..
rm -rf virtualenv-14.0.6*</pre>

## 安装oncotator依赖

<pre>git clone  https://github.com/broadinstitute/oncotator.git
cd oncotator
mkdir env
bash scripts/create_oncotator_venv.sh -e ./env</pre>
...
<pre>wget -c http://www.broadinstitute.org/~lichtens/oncobeta/oncotator_v1_ds_Jan262015.tar.gz
tar -xvzf  oncotator_v1_ds_Jan262015.tar.gz</pre>
...
![](https://raw.githubusercontent.com/ProfessionalFarmer/f4w/master/2020/2016-09-06-oncotator-annotation-maf.png)
