...
<pre>vcftools --vcf X.vcf --remove-indels --out X.snps --recode --recode-INFO-all</pre>

得到INDEL

<pre>vcftools --vcf X.vcf --keep-only-indels --out X.indel --recode --recode-INFO-all</pre>

# GATK

得到SNP

<pre>java -jar GenomeAnalysisTK.jar \
    -T SelectVariants \
    -R reference.fasta \
    -V X.vcf   \
    -selectType SNP \
